...
#source_list_num = ['preprocessed', 'k-anonymity_5', 'k-anonymity_50', 'k-anonymity_100', 'k-anonymity_500', 'k-anonymity_1000', 'k-anonymity_2000'] # For k-anonymity
...
#source_list_num = ['preprocessed', 'k-5_t-0.1', 'k-50_t-0.1', 'k-200_t-0.1', 'k-500_t-0.1', 'k-2000_t-0.1'] 
...
for m in source_list_mode:
    for k in source_list_num:
        ...
        #output_file_total = 'evaluation_k/MLP_evaluation_k_total.csv'
        #output_file_total = 'evaluation_k_l/MLP_evaluation_kl_total.csv'
        output_file_total = 'evaluation_k_l_t/MLP_evaluation_k=5_t_total.csv'
        #output_file_total = 'evaluation_k_l_t/MLP_evaluation_k_t=0.1_total.csv'
        #output_file_total = 'evaluation_k_l_t/MLP_evaluation_k_t=0.09_total.csv'
        ...
        mlp = Sequential()
        mlp.add(Dense(64, input_shape=(13,), activation='relu'))
        ...
        mlp.fit(x_train,y_train, batch_size=15, epochs=15)
